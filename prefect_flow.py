    ...
    def objective(params):
        with mlflow.start_run():
            ...
            booster = xgb.train(
                params=params,
                dtrain=train,
                num_boost_round=10,    ## change based on trial original 1000
                evals=[(valid, 'validation')],
                early_stopping_rounds=5  ## change based on trial original 100
            )
...
def main(train_path = "data/green_tripdata_2021-01.parquet",
    ...
    mlflow.set_tracking_uri("sqlite:///mlflow.db")    ## from top to here
